...
public class DefaultJSONParser extends AbstractJSONParser implements Closeable {
    ...
    public void parseArray(Type type, Collection array, Object fieldName) {
        ...
        // This is a single object, deserialise it as a singleton collection
        if (lexer.token() == JSONToken.LBRACE && isEnabled(Feature.SupportSingleValueAsArray)) {
            array.add(parseObject(type));
            return;
        }
